    ...
    <div id="container" style="width: 100%; margin: 0px auto; font-family: Arial">
        ...
        <div id="main">
            <div class="slide-show">
                <img id="img" onclick="changeImage()" src="front/TGDD_Picture/1.jpg" alt="Quảng cáo" />
            </div>
            <br />
            <div id="content">
                <div class="cate">
                ...
                <div class="list-product"> 
                    @foreach($Iphone as $dienthoai)
                    <div class="item col-3 col-s-6">
                        <a href=""><img class="item-photo" src="front/TGDD_Picture/product-1.webp"
                                alt="SP" /></a>
                        <a class=" product-name" href="{{ url('shop/sanpham/' . $dienthoai->MaSP) }}">{{$dienthoai->TenSP}}</a>
                        ...
                        <input class="btn-addToCart" type="button" value="Mua ngay" onclick="window.location.href='{{ url('cart/add/' . $dienthoai->MaSP) }}';">
                ...
                <div class="list-product"> 
                    @foreach($SamSung as $dienthoai)
                    <div class="item col-3 col-s-6">
                        <a href=""><img class="item-photo" src="front/TGDD_Picture/product-30.webp"
                                alt="SP" /></a>
                        <a class=" product-name" href="{{ url('shop/sanpham/' . $dienthoai->MaSP) }}">{{$dienthoai->TenSP}}</a>
                        <span class="new-price">{{$dienthoai->giatien}}$</span>
                        <span class="old-price"> 
                ...
                <div class="ad">
                    <img src="front/TGDD_Picture/banner01.jpg" alt="Quảng cáo 1" />
                </div>

                <div id="lienhe">
                    <a href="#" target="_self">
                        <img src="front/TGDD_Picture/lh1.png" style="width:70px; height:70px" />
                        <img src="front/TGDD_Picture/lh2.png" style="width:70px; height:70px" />
                        <img src="front/TGDD_Picture/lh3.png" style="width:70px; height:70px" />
                </div>
            </div>
        </div>
        <!-- -------------------------------------------------------------------------- -->
