    ...
    <div id="body-content">
        <div id="login">
          <form action="" method="post">
            @csrf
            <h1>ĐĂNG KÝ</h1>
            <input type="name" id="email" name="name" placeholder="Name">
            <input type="email" id="email" name="email" placeholder="Email">
            <input type="password" id="pass" name="password" placeholder="Mật khẩu">
            <input type="password" id="pass" name="password_confirmation" placeholder="Nhập lại mật khẩu">
           <input id="btnlogin" type="submit" value="Register an account">
            <a href="/">
                <h3>Trở về</h3>
            </a>
