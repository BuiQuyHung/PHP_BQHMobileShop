        ...
        <div id="main">
            ...
            <div id="content">
                ...
                <div class="list-product">
                    ...
                    @foreach($getTheLoaiSanPham as $sanpham)
                    <div class="item col-3 col-s-6">
                        <a href="product_details.html"><img class="item-photo" src="../../front/TGDD_Picture/product-1.webp"
                                alt="SP" /></a>
                        <a class=" product-name" href="{{ url('shop/sanpham/' . $sanpham->MaSP) }}">{{$sanpham->TenSP}}</a>
                ...
                <div class="pagination-justify-content-center">
                    <ul class="pagination">
                      @if ($getTheLoaiSanPham->currentPage() > 1)
                      ...
                      @for ($i = 1; $i <= $getTheLoaiSanPham->lastPage(); $i++)
                        <li class="{{ ($getTheLoaiSanPham->currentPage() == $i) ? ' active' : '' }}">
                          <a class="page" style="text-decoration: none; color:black" href="{{ $getTheLoaiSanPham->url($i) }}">{{ $i }}</a>
                        </li>
                        @endfor
              
                        @if ($getTheLoaiSanPham->hasMorePages())
                        <li><a class="page" style="text-decoration: none; color:black;" href="{{ $getTheLoaiSanPham->nextPageUrl() }}" rel="next">
                            >
                          </a>
                        </li>
                        @endif
